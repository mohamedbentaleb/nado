<div class="section-full content-inner-1 bg-primary text-white overlay-black-dark bg-img-fix" style="background-image:url({{ asset('assets/images/background/bg1.jpg') }});">
	<div class="container">
