...
@section('title' , 'Image slider | nado.ma')
          ...
          <div class="col-12">
              <div class="card">
                  <div class="card-header d-flex justify-content-between">
                      <h4 class="card-title">List Image slider</h4>
                      <a href="{{ route('imgslider.create')}}" class="btn btn-primary float-right">New Image slider</a>
                  </div>
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                        <div class="d-flex gap-2 w-100 justify-content-end">
                                          ...
                                          @include('admin.partials.deleteBtn', ["url" =>  route('imgslider.destroy' , $av) ])
                                        </div>
                                      </td>
                                  </tr>
                                @endforeach
